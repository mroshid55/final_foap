...
def team(request):
    ...
    return render(request, 'team/meet_the_team.html', {'cont': cont, 'logo': logo, 'team_mem': team_mem})
...
def profile_view(request, pk):
    ...
    cont = Contact.objects.all()  # Model Class Contact
    logo = Logo.objects.all()  # Model Class Logo
    return render(request, 'team/profile_view.html', {'tm_id': tm_id, 'cont': cont, 'logo': logo})
...
def doctor_team(request):
    ...
    return render(request, 'team/doctor_team.html', {'cont': cont, 'logo': logo, 'team_mem': team_mem})
